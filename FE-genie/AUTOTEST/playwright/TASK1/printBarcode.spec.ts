...
import { test } from "../../../../genie/playwright/fixtures/fixtures";
import { NewAdmissionPage } from "../../../../genie/playwright/pages/khach-hang/tiep-nhan/admission";
...
test.describe("Tiếp nhận mới - In mã vạch", () => {
  ...
  test("Scenario 1: In mã vạch gọi ws_MDM_Patient_CheckExists và xử lý thành công", async ({ page, searchPatientName }) => {
    const admissionPage = new NewAdmissionPage(page);
