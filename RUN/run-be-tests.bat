@echo off
REM Aladdin Backend Tests Runner
REM Batch script to run backend tests

echo.
echo ========================================
echo   Aladdin Backend Tests Runner
echo ========================================
echo.
...
powershell -ExecutionPolicy Bypass -File "%~dp0run-be-tests.ps1" %*
