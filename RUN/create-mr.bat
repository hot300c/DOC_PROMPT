@echo off
REM GitLab Merge Request Creator Launcher
REM Batch script to run the PowerShell MR creator

echo.
echo ========================================
echo   GitLab Merge Request Creator
echo ========================================
echo.
...
echo Starting Merge Request creator...
powershell -ExecutionPolicy Bypass -File "%~dp0create-mr.ps1" %*
